...
See the complete working example at [`examples/nextjs/`](https://github.com/user/murai/tree/main/examples/nextjs) — includes dashboard, top-up flow, webhook handler, and spend action.
